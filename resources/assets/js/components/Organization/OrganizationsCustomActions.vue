  <template>
    <div class="custom-actions">
      ...
      <a class="" @click="itemAction('edit-item', rowData, rowIndex)"><i class="fa fa-address-card-o fa-lg" aria-hidden="true"></i></a>
  ...
  export default {
    ...
    methods: {
      itemAction (action, data, index) {
        console.log('custom-actions organization: ' + action, data.name, index)
        // window.location.href = '/organization/'+this.rowData.id+'/edit';
      }
    }
  }
  </script>
