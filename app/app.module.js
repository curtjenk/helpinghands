var hhApp = angular.module('hhApp', ['ui.router', 'ui.bootstrap', 'angularUtils.directives.dirPagination', 'dndLists', 'ngMessages', 'LocalStorageModule', 'ngMaterial', 'ngSanitize', 'chart.js']);

// ticketFixApp.config(['$compileProvider', function ($compileProvider) {
//   $compileProvider.debugInfoEnabled(false);
// }]);//"run" executes once all modules have been loaded.
hhApp.run(function ($rootScope, $location, $urlRouter) {
...
hhApp.directive('disableBtn', function () {
	return {
		restrict: 'A',
...
*/
hhApp.directive('compareTo', function () {
	return {
		require: "ngModel",
		scope: {
...
hhApp.directive('checkImage', function ($http) {
	return {
		restrict: 'A',
		link: function (scope, element, attrs) {
